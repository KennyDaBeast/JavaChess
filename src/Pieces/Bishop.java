...
public class Bishop extends Piece{
    public Bishop(Chessboard chessboard, int col, int row, boolean isWhite){
        ...
        this.sprite = sheet.getSubimage(2 * sheetScale, isWhite ? 0 : sheetScale, sheetScale, sheetScale).getScaledInstance(chessboard.tileSize, chessboard.tileSize, BufferedImage.SCALE_SMOOTH);
